...
class Application:
    def __init__(self, output_path = "./"):
        ...
        self.botShoot = tk.Button(self.root, width=12, height=4, bd=4, 
            font=('arial', 14, 'bold'), text="CAPTURE", 
            activebackground="cyan", bg="cyan")
        self.botShoot.grid(row=12, column=18, pady=20)
        self.botShoot.configure(command=self.picam)        
        
        self.Output = tk.Label(self.root, text="Insert Health Passport",
            font=('arial', 25, 'normal'), height=7, width=30, bg="light cyan")
    ...
    def save_process(self):
        #patient_info = {'first_name' : patient_details[0],
        #                'middle_name': patient_details[2],
        #                'last_name'  : patient_details[2],
        #                'npid'       : patient_details[3],
        #                'dob'        : patient_details[4], 
        #                'gender'     : patient_details[5],
        #                'gender'     : patient_details[6]}
        x = requests.post(url, data = self.patient_details)
        print(x)
...
#        validMonths = set(['JAN','FEB','MAR','APR','MAY','JUN',
...
#        print(ocr_text)
#        #splitting text with comma into two values array
#        ocr_text_split = ocr_text.split(", ",1)
...
#            print("List not Valid")
#        
#        #Getting id from OCR to later compare with one from barcode 
#        get_id_ocr = take_date[0].replace("-","") 
#        #print(get_id_ocr)
...
#        #replace whitespcae with no space for date
#        to_date = take_date[1].replace(" ","")
#        print(to_date)
...
#                           MonthOfBirth==12):
#                            maxDay=31
#                        elif(MonthOfBirth== 4 or \
#                             MonthOfBirth== 6 or \
#                             MonthOfBirth== 9 or \
#                             MonthOfBirth==11):
#                            maxDay=30
#                        elif(YearOfBirth%4==0 and \
#                             YearOfBirth%100!=0 or \
#                             YearOfBirth%400==0):
#                            maxDay=29
#                        else:
#                            maxDay=28
...
#            #Check alphanumerical and observe any space spaces
#            district = re.sub(r'[^A-Za-z0-9 ]+', '', district)
#            print(district)
#            
#            #Process village
...
#            #Date of Birth
#            patient_details.append(str(DayOfBirth)   + "/" + \
#                                   str(MonthOfBirth) + "/" + \
#                                   str(YearOfBirth))
